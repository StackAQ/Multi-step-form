  ...
  return (
    <div className="bg-sky-100 h-screen">
      <div className="max-w-4xl mx-auto flex justify-center items-center flex-col lg:flex-row w-full h-screen">
        {/* Sidebar */}
        <div className="flex items-center flex-row lg:flex-col bg-[url('./src/assets/bg-sidebar-desktop.svg')] bg-cover bg-no-repeat bg-center text-white rounded-lg p-8 w-full lg:w-2/5 lg:h-screen">
          {[1, 2, 3, 4].map((step) => (
